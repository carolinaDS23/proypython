class ArbolBinarioBusqueda:
    ...
    def agregar(self,clave,valor): #agrega un arbol o crea una raiz
        if self.raiz:
            self._agregar(clave,valor,self.raiz)
        else:
            self.raiz = NodoArbol(clave,valor) #si no
    ...
    def obtener(self,clave): #busca un nodo mediante la clave, si la encuentra devuelve el valor, y si no es asi none
        if self.raiz: #if self.raiz != none
            res = self._obtener(clave,self.raiz)
            if res:
                return res.cargaUtil #devuelve el valor de la clave
            else:
                return None
        else:
            return None
    ...
    def longitud(self): #devuelve el tamaño del arbol
        return self.tamano

    def __len__(self): #devuelve el tamaño del arbol
        return self.tamano
